...
const RegisterScreen = ({location, history}) => {
    ...
    const {loading, error, userInfo} = useSelector(st=> st.userRegister)
        ...
        <FormContainer>
            ...
            <Form onSubmit={submitHandler}>
                ...
                <Form.Group controlId="password">
                    ...
                    <Form.Control type="password"  placeholder="Enter password" value={password} required={true} onChange={(e)=> setPassword(e.target.value)}></Form.Control>
                </Form.Group>
                <Form.Group controlId="confirmPassword">
                    <Form.Label>Confirm Password </Form.Label>
                    <Form.Control type="password"  placeholder="Confirm password" value={confirmPassword} required={true} onChange={(e)=> setConfirmPassword(e.target.value)}></Form.Control>
                </Form.Group>
